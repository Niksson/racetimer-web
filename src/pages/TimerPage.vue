  ...
  <div id="timer-page">
    ...
    <div class="divider-custom">
      <div class="divider-content absolute w-full -top-5 flex justify-between">
        <button class="ml-8 w-32 text-lg h-10 btn btn-outline bg-base-100" @click="puzzlesModal?.modal?.showModal">NEW
          RACE</button>
        <button class="mr-8 w-32 text-lg h-10 btn btn-outline bg-base-100"
